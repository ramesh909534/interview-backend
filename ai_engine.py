...
# =====================================================
# GENERATE QUESTIONS (HR / TECH / FINAL HR)
# =====================================================
...
# =====================================================
# BASIC EVALUATION (OLD API – DO NOT BREAK)
# =====================================================
...
# =====================================================
# ADVANCED HR EVALUATION (PHASE 4 – INTERNAL)
# =====================================================
def evaluate_hr_detailed(question: str, answer: str):
    """
    Recruiter-grade HR evaluation
    """
    try:
        prompt = (
...
def evaluate_detailed(question: str, answer: str):
    """
    Wrapper for backend compatibility.
    DO NOT REMOVE.
    """
    try:
